...
app.post('/webhook', async (c) => {
	...
	const discordRepository: DiscordRepository = new DiscordRepositoryImpl('https://github.com/moko256/discord-inviter-misskey-cfw', '1.0.0');
	const misskeyRepository: MisskeyRepository = new MisskeyRepositoryImpl();

	const inviterUseCase: InviterUseCase = new InviterUseCaseImpl(configRepository, discordRepository, misskeyRepository);
